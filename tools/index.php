...
require_once ("build_evaluator_configuration.php");
require_once ("activity_automatic_evaluation.php");
...
require_once ("support_progress.php");
require_once ("support_video.php");
require_once ("fetch_support_asset.php");
require_once ("support_video_jobs.php");
...
require_once ("get_activity_medal_for_team.php");
require_once ("get_next_activities.php");
require_once ("get_week_projects.php");
require_once ("get_managed_activities.php");
require_once ("official_correction_medals.php");
require_once ("edit_medal.php");
...
require_once ("automatic_subscription.php");
...
require_once ("build_document.php");
