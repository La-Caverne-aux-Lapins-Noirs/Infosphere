...
$FamousQuote["fr"] = [
    ...
    "'Un de ces jours' signifie aucun de ces jours",
    ...
    "La pierre erreur n'est pas dans l'échec mais dans l'incapacité de dominer l'échec",
    ...
    "La liberté de la presse présente des inconvénients, mais moins que l'absence de liberté de la presse",
    "La clarté en politique est la forme la plus difficile du courage",
    ...
    "La culture, un peu comme le bonheur, se partage",
    ...
    "Le Français est un critique par essence, c'est l'un de ses charmes..",
    "Les promesses n'engagent que ceux qui les recoivent",
    "Le pessimisme ouvre la voie à tous les renoncements",
    "C'est le déclin quand l'homme se dit 'Que va-t-il se passer?' au lieu de se dire 'Que vais-je faire?'",
    "Aucune civilisation n'a durée quand elle acceptait la fracture sociale des exclus",
