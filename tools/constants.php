...
define("INTERCOM_PRIVATE", 2); // CIPHERED COMMUNICATION (TWO COMS ONLY)
define("INTERCOM_ADMIN", 1); // ONLY DIRECTORS AND TEACHERS
define("INTERCOM_PUBLIC", 0); // PUBLIC (OR LIMITED TO LAB/MISC)
